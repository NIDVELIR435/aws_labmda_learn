# AWS lambdas app with AWS SAM CLI support
...
**_NOTE:_** So far SAM CLI have bug when we execute "sam build" CLI cannot install "esbuild", so you have to manually move "esbuild" row from "devDependencies" to "dependencies"
